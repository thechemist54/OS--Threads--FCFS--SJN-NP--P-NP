...
public class Fcfs {
     ...
     */
    public Fcfs(Map<Integer, Integer> mpp1, Map<Integer, Integer> mpp2, String algo)
    {
    ...
    public void fileString()
    {
        try
        {
            FileWriter fileWriter = new FileWriter("fcfs_out.txt");
            ...
            printwr.println("---------------------------------------------------------");
            String mi = "";
            Iterator<Integer> iter = mpp1.keySet().iterator();
            int coun = 0;
            int cou = 0;
            int mini = 0;
