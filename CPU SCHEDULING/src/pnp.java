...
public class pnp {
     ...
     */
    public pnp(Map<Integer, Integer> mpp1, Map<Integer, Integer> mpp2,
                Map<Integer, Integer> mpp6,  String algo)
    {
    ...
    public void fileString()
    {
        try
        {
            FileWriter fileWriter = new FileWriter("pnp_out.txt");
            ...
            printwr.println("---------------------------------------------------------");
            String mi = "";
            Iterator<Integer> iter = mpp6.keySet().iterator();
            int coun = 0;
            int cou = 0;
            int mini = 0;
            ...
            while(iter.hasNext()) {
                ...
                mi = mini + " " + mpp1.get(mini) + " " + mpp2.get(mini) +" "+mpp6.get(mini);
